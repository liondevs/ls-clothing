...
Config.ClothingRooms = {
    [1] = {requiredJob = 'police', isGang = false, coords = vector3(462.55, -998.96, 30.69), width = 2, length = 2, cameraLocation = vector4(462.55, -998.96, 30.69, 89.08)},
    ...
    [4] = {requiredJob = 'ambulance', isGang = false, coords = vector3(-825.76, -1237.05, 7.34), width = 2, length = 2, cameraLocation = vector4(-825.76, -1237.05, 7.34, 315.12)},
        ...
        ['male'] = {
            ...
            [0] = {
                ...
                [1] = {
                    outfitLabel = 'T-Shirt',
                    outfitData = {
                        ['arms'] = {item = 82, texture = 0}, -- Arms
                        ['t-shirt'] = {item = 16, texture = 0}, -- T-Shirt
                        ['torso2'] = {item = 346, texture = 0}, -- Jackets
                        ['vest'] = {item = 0, texture = 0}, -- Vest
                        ['decals'] = {item = 70, texture = 0}, -- Decals
                        ['accessory'] = {item = 58, texture = 0}, -- Neck
                        ['bag'] = {item = 0, texture = 0}, -- Bag
                        ['pants'] = {item = 175, texture = 0}, -- Pants
                        ['shoes'] = {item = 104, texture = 0}, -- Shoes
                        ['mask'] = {item = 0, texture = 0}, -- Mask
                        ['hat'] = {item = 139, texture = 0}, -- Hat
                        ['glass'] = {item = 0, texture = 0}, -- Glasses
